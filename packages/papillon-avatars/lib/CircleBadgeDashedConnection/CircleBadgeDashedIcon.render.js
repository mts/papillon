...
// const CircleBadgeDashedConnection = process.env.NODE_ENV === 'develop'
//   ? require('./CircleBadgeDashedConnection').default
//   : require('../lib/papillon-avatars').CircleBadgeDashedConnection;

const CircleBadgeImage = require('../CircleBadgeImage').default

const CircleBadgeDashedConnection = require('./CircleBadgeDashedConnection').default
