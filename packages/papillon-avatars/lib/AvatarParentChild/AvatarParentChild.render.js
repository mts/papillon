...
const Avatar = process.env.NODE_ENV === 'develop' ? require('../Avatar').default : require('../../build/papillon-avatars').Avatar

const AvatarParentChild =
  process.env.NODE_ENV === 'develop' ? require('./AvatarParentChild').default : require('../../build/papillon-avatars').AvatarParentChild
