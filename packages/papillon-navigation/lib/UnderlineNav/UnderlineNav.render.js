...
const UnderlineNav =
  process.env.NODE_ENV === 'develop' ? require('./UnderlineNav').default : require('../../build/papillon-navigation').UnderlineNav
...
const itemsWithIcons = [
  { href: '#url', role: 'tab', title: 'Item 1', text: 'Item 1', icon: 'tools' },
  { href: '#url', role: 'tab', title: 'Item 2', text: 'Item 2', icon: 'tools', counter },
  { href: '#url', role: 'tab', title: 'Item 3', text: 'Item 3', icon: 'tools' },
  { href: '#url', role: 'tab', title: 'Item 4', text: 'Item 4', icon: 'tools' },
]

const href = 'https://github.com/mts/papillon/tree/master/packages/papillon-navigation/UnderlineNav'

const underlineNavAction = (
